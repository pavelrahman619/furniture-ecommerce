            ...
            <div className="accessories-single-category">
              ...
              <img
                src={
                  ...
                  "/assets/images/category/bathroom/4.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-2 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/1.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-3 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/8.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={5} md={11} className="offset-lg-1 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/9.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={9} md={10} className="space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/2.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={4} md={8} className="offset-lg-1 offset-md-2 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/6.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={4} md={8} className="offset-lg-2 offset-md-1 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/7.png"
                }
                className="img-fluid"
                alt=""
              />
          ...
          <Col lg={9} md={8} className="offset-lg-3 offset-md-3 space-mb--r100">
            <div className="accessories-single-category">
              ...
              <img
                src={
                  process.env.PUBLIC_URL +
                  "/assets/images/category/bathroom/3.png"
                }
                className="img-fluid"
                alt=""
              />
